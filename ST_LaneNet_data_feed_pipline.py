# -*- coding: utf-8 -*-
# @Time    : 21-4-23 下午3:54
# @File    : ST_LaneNet_data_feed_pipline.py
# @IDE: PyCharm
"""
ST_LaneNet data feed pip line
"""
import argparse
import glob
import os
...
class ST_LaneNetDataProducer(object):
    """
...
class ST_LaneNetDataFeeder(object):
    """
...
if __name__ == '__main__':
    ...
    producer = ST_LaneNetDataProducer(dataset_dir=args.dataset_dir)

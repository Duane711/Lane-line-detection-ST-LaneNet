# -*- coding: utf-8 -*-
# @Time    : 21-8-16 下午6:26
# @File    : evaluate_ST_LaneNet_on_CULane.py
# @IDE: PyCharm
"""
Evaluate ST_LaneNet model on CULane lane dataset
"""
import argparse
import glob
import os
...
def init_args():
    ...
    parser.add_argument('--image_dir', type=str, help='The source CULane lane test data dir')
...
def test_ST_LaneNet_batch(src_dir, weights_path, save_dir):
    """
    ...
    net = ST_LaneNet.ST_LaneNet(phase='test', net_flag='vgg')

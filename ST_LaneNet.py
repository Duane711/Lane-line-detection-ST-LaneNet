...
# @IDE: PyCharm
"""
Implement ST_LaneNet Model
"""
import tensorflow as tf

from config import global_config
from ST_LaneNet_model import ST_LaneNet_back_end
from ST_LaneNet_model import ST_LaneNet_front_end
from semantic_segmentation_zoo import cnn_basenet

CFG = global_config.cfg


class ST_LaneNet(cnn_basenet.CNNBaseModel):
    """
    ...
    def __init__(self, phase, net_flag='vgg', reuse=False):
        ...
        """
        super(ST_LaneNet, self).__init__()
        self._net_flag = net_flag
        self._reuse = reuse

        self._frontend = ST_LaneNet_front_end.ST_LaneNetFrondEnd(
            phase=phase, net_flag=net_flag
        )
        self._backend = ST_LaneNet_back_end.ST_LaneNetBackEnd(
            phase=phase
        )
    ...
    def compute_loss(self, input_tensor, binary_label, instance_label, name):
        """
        calculate ST_LaneNet loss for training
        :param input_tensor:
        :param binary_label:
